...
# Constants
HF_API_URL = os.getenv("HF_API_URL", "https://rishabh2234-image-captionator.hf.space/generate_caption/")
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "")  # Set GROQ_API_KEY in your .env file
